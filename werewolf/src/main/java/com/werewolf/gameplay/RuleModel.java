...
public class RuleModel {
    ...
    private ArrayList<LobbyInitializationRule> lobbyInitializationRules = new ArrayList<>();
    private ArrayList<NightRule> nightRules = new ArrayList<>();
    private ArrayList<PlayerInitializationRule> playerInitializationRules = new ArrayList<>();
    ...
    public void addLobbyInitializationRule(LobbyInitializationRule rule) { lobbyInitializationRules.add(rule); }
    public void addNightRule(NightRule rule) { nightRules.add(rule); }
    public void addPlayerInitializationRule(PlayerInitializationRule rule) { playerInitializationRules.add(rule); }
    ...
    public ArrayList<LobbyInitializationRule> getLobbyInitializationRules() { return lobbyInitializationRules; }
    public ArrayList<NightRule> getNightRules() { return nightRules; }
    public ArrayList<PlayerInitializationRule> getPlayerInitializationRules() { return playerInitializationRules; }
